  ...
  return (
    <div className="max-w-xl mx-auto bg-base-100 shadow-lg rounded-lg p-6 mt-20">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        />
        {errors.poster && (
          <p className="text-red-500 text-sm">Valid URL required</p>
        )}
        ...
        {errors.releaseYear && (
          <p className="text-red-500 text-sm">Release year is required</p>
        )}
        ...
        <button
          type="submit"
          className="btn  bg-transparent   rounded-2xl border-0 border-b-2 border-yellow-300  hover:text-blue-100 text-lg text-gray-900 hover:bg-gray-800 shadow-none hover:border-0 w-full"
        >
          Update Movie
        </button>
      </form>
